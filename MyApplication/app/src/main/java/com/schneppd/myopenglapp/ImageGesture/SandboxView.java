package com.schneppd.myopenglapp.ImageGesture;

/**
 * Created by schneppd on 7/24/17.
 */
...
public class SandboxView extends ImageView implements OnTouchListener {
			...
			if (touchManager.getPressCount() == 1) {
				...
				if (touchManager.getPressCount() == 2) {
					...
					if (previousDistance != 0) {
						...
						Log.d("SandboxView", "scale" + scale);
					}
					else{
						angle -= Vector2D.getSignedAngleBetween(current, previous);
						Log.d("SandboxView", "rotqte" + angle);
					}
